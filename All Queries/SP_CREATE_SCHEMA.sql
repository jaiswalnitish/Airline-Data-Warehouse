-- Stored procedure to create schema. This is created so that it can be called from SSIS and 
-- we dont need to explicitely run the scripts before executing SSIS. 
